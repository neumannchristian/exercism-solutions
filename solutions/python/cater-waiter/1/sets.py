...
from sets_categories_data import (EXAMPLE_INTERSECTION, VEGAN,
                                  VEGETARIAN,
                                  KETO,
                                  PALEO,
                                  OMNIVORE,
...
def singleton_ingredients(dishes, intersection):
    ...
    all_ingredients = set()
    multi_ingredients = set()

    for dish in dishes:
        multi_ingredients |= all_ingredients & dish
        all_ingredients |= dish

    return all_ingredients - multi_ingredients - intersection
